...
public class AppointTestDto {
    ...
    public AppointTestDto(Integer id, UserDtoNameOnlyWithPositionDto userDtoNameOnlyWithPositionDto,
    ...
    public static AppointTestDto getInstance(AppointTest appointTest){
        return new AppointTestDto(appointTest.getId(), UserDtoNameOnlyWithPositionDto.getInstance(appointTest.getUser()),
